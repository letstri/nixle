...
const k = (E, e) => Object.fromEntries(Object.entries(E).filter(([r]) => !e.includes(r))), d = (E) => E !== Object(E), p = (...E) => {
...
const y = (E) => E instanceof Y, b = (E, e) => {
  let r = "";
  if (y(E) || E instanceof Error ? r = E.message : d(E) ? r = E : r = `${E.constructor.name} ${JSON.stringify(E)}`, E && (!E.statusCode || E.statusCode >= T.INTERNAL_SERVER_ERROR))
...
`, n] : []);
  ...
  const r = V().format(), n = d(E), i = n && E || E.message || "Internal Server Error", s = n && r || E.time || r, I = n && {} || E.details || {}, _ = n && void 0 || E.code, o = {
    statusCode: e,
    message: i,
    time: s,
    details: I,
