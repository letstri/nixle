...
const eE = (E, e) => {
  ...
  c.forEach(({ path: s, method: O, options: _ }) => {
    const o = b(r, s), h = f(`${Y.bold(O)} ${o}`, "bgGreen");
    E.provider.createRoute({
      ...
      async handler(I) {
        ...
        try {
          ...
          return I.setStatusCode(t), L(i, t);
        }
        try {
        ...
        try {
          ...
          return D.emit("response", i), _?.statusCode && I.setStatusCode(_.statusCode), i;
        } catch (i) {
          const t = i?.statusCode || T.INTERNAL_SERVER_ERROR;
          return P(i, h), I.setStatusCode(t), L(i, t);
        }
      }
    }), h.info("🚏 Route registered");
  });
};
function IE(E) {
